#include "stereo_visual_odometry/optimization/G2O_Optimization.hpp"

namespace SVO {
G2O_Optimization::G2O_Optimization() {
...
void G2O_Optimization::BundleAdjustment(const WorldPoints &points3D, const CameraPoints &points2D,
